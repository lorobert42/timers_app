...
class NewTimerDialog extends StatefulWidget {
  ...
  const NewTimerDialog({super.key, required this.onAddCard});

  @override
  State<NewTimerDialog> createState() => _NewTimerDialogState();
}

class _NewTimerDialogState extends State<NewTimerDialog> {
