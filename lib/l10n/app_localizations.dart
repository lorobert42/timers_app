...
abstract class AppLocalizations {
  ...
  /// How to format the selected duration text.
  ///
  /// In en, this message translates to:
  /// **'{duration}'**
  ...
  /// No description provided for @alarmNotification.
  ///
  /// In en, this message translates to:
  /// **'Time is out.'**
  String get alarmNotification;

  /// No description provided for @channelDescription.
  ///
  /// In en, this message translates to:
  /// **'Alarm when a timer is over.'**
  ...
  /// Pluralization of minutes.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =0{} =1{1 Minute} other{{count} Minutes}}'**
  String nMinutes(num count);

  /// Pluralization of Seconds.
  ///
  /// In en, this message translates to:
  /// **'{count, plural, =1{1 Second} other{{count} Second}}'**
